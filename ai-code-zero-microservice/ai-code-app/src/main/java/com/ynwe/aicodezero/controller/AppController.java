...
import com.ynwe.aicodezero.common.DeleteRequest;
import com.ynwe.aicodezero.common.ResultUtils;
import com.ynwe.aicodezero.constant.AppConstant;
import com.ynwe.aicodezero.constant.UserConstant;
...
import com.ynwe.aicodezero.model.dto.app.*;
...
import com.ynwe.aicodezero.ratelimit.annotation.RateLimit;
import com.ynwe.aicodezero.ratelimit.enums.RateLimitType;
import com.ynwe.aicodezero.service.AppService;
import com.ynwe.aicodezero.service.ProjectDownloadService;
...
public class AppController {
    ...
    @RateLimit(limitType = RateLimitType.USER, rate = 5, rateInterval = 60, message = "AI 对话请求过于频繁，请稍后再试")  //一分钟一个用户最多请求5次
    ...
    public BaseResponse<Page<AppVO>> listMyAppVOByPage(@RequestBody AppQueryRequest appQueryRequest, HttpServletRequest request) {
        ...
        // 只查询当前用户的应用，直接将用户的userId作为查询的条件，用户只能查看自己创建的应用
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.ynwe.aicodezero.uttils.CacheKeyUtils).generateKey(#appQueryRequest)",
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)  //权限校验注解
