package com.ynwe.aicodezero.core.saver;
...
public abstract class CodeFileSaverTemplate<T> {
    ...
    // 文件保存根目录  AppConstant.CODE_OUTPUT_ROOT_DIR 等价于 System.getProperty("user.dir") + "/tmp/code_output"
    ...
    protected final String buildUniqueDir(Long appId) {
        if (appId == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "应用appId不能为空");
        }
