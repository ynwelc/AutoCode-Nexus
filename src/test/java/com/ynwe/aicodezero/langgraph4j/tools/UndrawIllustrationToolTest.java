package com.ynwe.aicodezero.langgraph4j.tools;

import com.ynwe.aicodezero.langgraph4j.model.ImageResource;
import com.ynwe.aicodezero.langgraph4j.model.enums.ImageCategoryEnum;
...
class UndrawIllustrationToolTest {
    ...
    void testSearchIllustrations() {
        // 测试正常搜索插画
        List<ImageResource> illustrations = undrawIllustrationTool.searchIllustrations("love");
